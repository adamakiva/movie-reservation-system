...
import type { genreValidator as validator } from '../../validators/index.js';

/**********************************************************************************/

type CreateGenreValidatedData = ReturnType<
  typeof validator.validateCreateGenre
>;
type UpdateGenreValidatedData = ReturnType<
  typeof validator.validateUpdateGenre
>;
type DeleteGenreValidatedData = ReturnType<
  typeof validator.validateDeleteGenre
>;
