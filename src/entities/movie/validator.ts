...
const createMovieSchema = Zod.object({
  ...
  imagePath: Zod.string({
    invalid_type_error: MOVIE.IMAGE.INVALID_TYPE_ERROR_MESSAGE,
    required_error: MOVIE.IMAGE.REQUIRED_ERROR_MESSAGE,
  })
    .min(MOVIE.IMAGE.MIN_LENGTH.VALUE, MOVIE.IMAGE.MIN_LENGTH.ERROR_MESSAGE)
    .max(MOVIE.IMAGE.MAX_LENGTH.VALUE, MOVIE.IMAGE.MAX_LENGTH.ERROR_MESSAGE),
  price: Zod.coerce
    .number({
      invalid_type_error: MOVIE.PRICE.INVALID_TYPE_ERROR_MESSAGE,
      required_error: MOVIE.PRICE.REQUIRED_ERROR_MESSAGE,
    })
    .min(MOVIE.PRICE.MIN_LENGTH.VALUE, MOVIE.PRICE.MIN_LENGTH.ERROR_MESSAGE)
    .max(MOVIE.PRICE.MAX_LENGTH.VALUE, MOVIE.PRICE.MAX_LENGTH.ERROR_MESSAGE),
  genreId: Zod.string({
