...
exec node --experimental-transform-types --watch --stack-trace-limit=32 --disable-proto=delete --trace-exit --force-node-api-uncaught-exceptions-policy --enable-source-maps --trace-uncaught --trace-warnings --max-old-space-size=1536 ./src/main.ts;
