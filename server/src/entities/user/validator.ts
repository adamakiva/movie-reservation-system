...
const getUsersSchema = ZodObject(
  {
    cursor: ZodString({
...
const createUserSchema = ZodObject({
  firstName: ZodString({
...
const updateUserBodySchema = ZodObject({
  firstName: ZodString({
    invalid_type_error: USER.FIRST_NAME.INVALID_TYPE_ERROR_MESSAGE,
    required_error: USER.FIRST_NAME.REQUIRED_ERROR_MESSAGE,
  })
...
const updateUserParamsSchema = ZodObject(
  {
    user_id: ZodString({
      invalid_type_error: USER.ID.INVALID_TYPE_ERROR_MESSAGE,
      required_error: USER.ID.REQUIRED_ERROR_MESSAGE,
...
const deleteUserSchema = ZodObject(
  {
    user_id: ZodString({
      invalid_type_error: USER.ID.INVALID_TYPE_ERROR_MESSAGE,
      required_error: USER.ID.REQUIRED_ERROR_MESSAGE,
