...
const MOVIE = {
  ...
  POSTER: {
    INVALID_TYPE_ERROR_MESSAGE: 'Poster must be a valid string',
    REQUIRED_ERROR_MESSAGE: 'Poster is required',
    // No file path validation because the file path is generated by the server
    ABSOLUTE_FILE_PATH: {
      INVALID_TYPE_ERROR_MESSAGE:
        'Poster file absolute path must be a valid string',
...
const MOVIE_SCHEMAS = {
  ...
  CREATE: zod.object({
    ...
    genreId: zod
      .string({
        invalid_type_error: MOVIE.GENRE_ID.INVALID_TYPE_ERROR_MESSAGE,
        required_error: MOVIE.GENRE_ID.REQUIRED_ERROR_MESSAGE,
      })
      .uuid(MOVIE.GENRE_ID.ERROR_MESSAGE),
  }),
  UPDATE: {
    BODY: zod
      .object({
