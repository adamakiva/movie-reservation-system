...
const reserveShowtimeTicketSchema = zod.object(
  {
    showtime_id: zod
      .string({
        invalid_type_error: SHOWTIME.ID.INVALID_TYPE_ERROR_MESSAGE,
...
const cancelUserShowtimeReservationSchema = zod.object(
  {
    showtime_id: zod
      .string({
        invalid_type_error: SHOWTIME.ID.INVALID_TYPE_ERROR_MESSAGE,
...
const getUserShowtimesParamsSchema = zod.object(
  {
    user_id: zod
      .string({
...
const getUserShowtimesQuerySchema = zod
  .object(
    {
      cursor: zod
        .string({
